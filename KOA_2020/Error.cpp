...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(140, "Синтаксический анализ обнаружил ошибки и завершил выполнение программы."),
		ERROR_ENTRY(141, "Ошибка в подключении библиотек или Неверная структура программы"),

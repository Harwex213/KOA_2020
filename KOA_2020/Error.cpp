...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(408, "Неверный параметр возвращаемого типа"), //half-done
		ERROR_ENTRY(409, "Превышено максимальное количество параметров функции (не больше 8)"), //done
		ERROR_ENTRY(410, "Несоответствие типов формальных и фактических параметров при вызове функции"), //half-done
		ERROR_ENTRY(411, "Несоответствие количества формальных и фактических параметров при вызове функци"), //done
		ERROR_ENTRY(412, "Невозможно преобразовать тип правостороннего операнда к типу левостороннего"), //half-done
		ERROR_ENTRY(413, "Использован запрещенный оператор с данными операндами."), //half-done

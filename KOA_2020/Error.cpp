...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(120, "Ошибка при лексическом анализе: Неправильная лексика ключевого слова"), //done
		...
		ERROR_ENTRY(140, "Синтаксический анализ обнаружил ошибки и завершил выполнение программы."), //done
		ERROR_ENTRY(141, "Ошибка в подключении библиотек или Неверная структура программы"), //done
		ERROR_ENTRY(142, "Ошибочная инструкция"), //done
		ERROR_ENTRY(143, "Ошибочное выражение"), //done
		...
		ERROR_ENTRY(403, "Выход за диапазон допустимых целочисленных значений для литерала"), //done
		ERROR_ENTRY(404, "Выход за диапазон допустимого строкового значения для литерала"), //done
		...
		ERROR_ENTRY(408, "Неверный параметр возвращаемого типа"), //done
		ERROR_ENTRY(409, "Превышено максимальное количество параметров функции (не больше 8)"), //done
		ERROR_ENTRY(410, "Несоответствие типов формальных и фактических параметров при вызове функции"), //done
		ERROR_ENTRY(411, "Несоответствие количества формальных и фактических параметров при вызове функци"), //done
		ERROR_ENTRY(412, "Невозможно преобразовать тип правостороннего операнда к типу левостороннего"), //done
		ERROR_ENTRY(413, "Использован запрещенный оператор с данными операндами"), //done
		ERROR_ENTRY(414, "Прототип функции не найден для текущих библиотек"), // done
		ERROR_ENTRY(415, "Подключена неизвестная библиотека"), // undone
		ERROR_ENTRY(416, "Лишняя лексема окончания выражения"), // done
